  ...
  return (
    <section className={`relative bg-transparent py-4 sm:py-6 ${inter.className}`}>
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative overflow-hidden rounded-[24px] sm:rounded-[30px] bg-gradient-to-r from-[#5932EA] via-[#2463EB] to-[#00C4CC] px-6 py-5 sm:px-10 sm:py-6 lg:px-12 lg:py-6.5 shadow-lg shadow-blue-900/12">
          
          {/* Subtle Ambient Backdrops */}
          <div className="pointer-events-none absolute -left-10 -top-10 h-44 w-44 rounded-full bg-white/15 blur-xl"></div>
          <div className="pointer-events-none absolute -right-10 -bottom-10 h-48 w-48 rounded-full bg-cyan-300/20 blur-xl"></div>
          ...
          <div className="relative z-10 grid grid-cols-1 items-center gap-6 md:grid-cols-[1.45fr_0.7fr] lg:grid-cols-[1.5fr_0.65fr] lg:gap-8">
            ...
            <div className="flex flex-col items-start text-left">
              ...
              <p className="mt-2 text-xs sm:text-[13.5px] text-blue-50/95 font-normal leading-relaxed max-w-lg">
              ...
              <div className="mt-4 sm:mt-5">
                <a
                  href="#hero"
                  className="inline-flex items-center gap-2.5 rounded-xl bg-white px-5 py-2.5 sm:px-6 sm:py-3 text-xs sm:text-sm font-bold text-[#0B1E3D] shadow-sm transition-all duration-200 hover:bg-slate-50 hover:shadow-md active:scale-95"
                >
            ...
            <div className="relative flex items-center justify-center md:justify-end">
              <div className="relative w-full max-w-[250px] sm:max-w-[270px] lg:max-w-[280px] overflow-hidden rounded-[24px] sm:rounded-[28px] border border-white/35 bg-white/10 p-1.5 backdrop-blur-xs shadow-xl shadow-blue-950/20">
