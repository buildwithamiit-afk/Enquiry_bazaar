  ...
  return (
    <section id="hero" className={`relative isolate overflow-hidden bg-white text-gray-900 ${inter.className}`}>
      ...
      <div className="pointer-events-none absolute inset-0 -z-10 select-none overflow-hidden">
        ...
        <div className="absolute top-1/4 right-[-5%] h-[350px] w-[350px] rounded-full bg-blue-500/4 blur-[70px]"></div>
        ...
        <div className="absolute inset-x-0 top-0 h-px bg-gradient-to-r from-transparent via-blue-500/15 to-transparent"></div>
      </div>
      ...
      <div className="mx-auto w-full max-w-7xl px-5 pb-12 pt-8 sm:px-8 sm:pt-10 lg:px-10 lg:pb-16 lg:pt-12 xl:pt-14">
        <div className="grid items-center gap-8 lg:grid-cols-[1fr_1.15fr] xl:grid-cols-[1fr_1.25fr] lg:gap-10 xl:gap-14">
          ...
          <div className="relative z-10 flex flex-col items-center text-center lg:items-start lg:text-left">
            ...
            {/* Pill Tag */}
            <div
              className="reveal mb-3 inline-flex items-center gap-2 rounded-full border border-blue-100 bg-blue-50/80 px-3.5 py-1 text-[11.5px] font-bold text-[#1E5EFF] shadow-2xs"
              style={reveal(20)}
            >
            ...
            {/* Main Headline */}
            <h1
              className={`reveal text-[2rem] font-extrabold leading-[1.15] tracking-tight text-[#0B1E3D] sm:text-3xl lg:text-[2.65rem] xl:text-[2.85rem] ${montserrat.className}`}
              style={reveal(40)}
            >
              No New <span className="text-[#1E5EFF]">Bulk Inquiries?</span> Your Competitors May Be Taking Them.
            </h1>
            ...
            <div className="reveal mt-4 flex items-center justify-center gap-2.5 border-t border-slate-100 pt-3.5 text-xs lg:justify-start" style={reveal(380)}>
              <div className="flex shrink-0 -space-x-1.5">
                <div className="flex h-6 w-6 items-center justify-center rounded-full border-2 border-white bg-[#0B1E3D] text-[8px] font-bold text-white shadow-xs">MB</div>
                <div className="flex h-6 w-6 items-center justify-center rounded-full border-2 border-white bg-[#1E5EFF] text-[8px] font-bold text-white shadow-xs">SK</div>
